...
MakeAToonNameBlacklist = [
    'fuck', 'ass', 'nigga',
    'bitch', 'damn', 'vagina',
    'pussy', 'dick', 'cock', 'penis',
    'shit', 'suck', 'nigger',
    'whore', 'maconha', 'weed', 'faggot',
    'gay', 'buttplug', 'cocaine', 'heroin',
    'lsd', 'puta', 'buceta', 'pepeca',
    'bilau', 'porra', 'caralho', 'crack', 'cocaina',
    'heroina', 'blowjob', 'handjob', 'footjob',
    'wank', 'punheta', 'masturb', 'boquete',
    'fisting', 'anus', 'rape', 'sex', 'estupro',
    'ejacula', 'dildo', 'zoofilia',
    'xvideos', 'redtube', 'lesbic',
    'homosexual', 'bastard', 'marijuana',
    'cuzinho', 'transa', 'anal', 'cannabis', 'pedo',
]
