...
GlobalStreetNames = {
    ...
    19000: ('para o', 'no', 'Hall das Torres')}
...
SuitAttackTaunts = {
    ...
    'CigarSmoke': ['Se importa se eu der uma fumadinha?',
                'Mais um Toonar virou fumaça.',
                'Lembrem-se Toons, não fumem, ao não ser que vocês sejam um ' + Cog + '.'],}
